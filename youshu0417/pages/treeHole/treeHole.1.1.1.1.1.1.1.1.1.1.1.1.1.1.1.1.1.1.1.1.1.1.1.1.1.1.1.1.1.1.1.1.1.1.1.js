...
function getDeleteCountdown(deleteOption, createTime) {
  ...
  if (deleteOption === 1) deleteTime = new Date(create.getTime() + 24 * 60 * 60 * 1000) // 24小时
  else if (deleteOption === 2) deleteTime = new Date(create.getTime() + 7 * 24 * 60 * 60 * 1000) // 7天
  else if (deleteOption === 3) deleteTime = new Date(create.getTime() + 30 * 24 * 60 * 60 * 1000) // 30天
