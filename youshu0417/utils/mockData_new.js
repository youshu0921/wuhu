...
// 匿名头像 - 渐变色块、抽象符号、无脸插画风格（使用多占位图服务）
...
const treeHolePosts = [
  {
    ...
    liked: false,
    comments: [
      { nickname: anonymousNicknames[5], content: "加油， 我也在经历" },
      { nickname: anonymousNicknames[8], content: "28还好， 不急" }
    ]
  },
  {
    id: "th_002",
  ...
  },
  {
    ...
    liked: false,
    comments: [
      { nickname: anonymousNicknames[10], content: "同感， 一起加油" }
    ]
  }
]
